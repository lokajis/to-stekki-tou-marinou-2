...
function Buttons () {
    ...
    <div className="flex gap-5 max-md:flex-col ">
        ...
        <div className="hover:bg-lime-950 hover:text-gray-200 cursor-pointer	 text-center	 grow justify-center items-center px-10 pt-24 pb-12 w-full text-2xl font-light text-lime-900 uppercase whitespace-nowrap bg-stone-100 max-md:px-5 max-md:pt-10 max-md:mt-10">
          Contact
      </div>
    </div>
  </div>);
